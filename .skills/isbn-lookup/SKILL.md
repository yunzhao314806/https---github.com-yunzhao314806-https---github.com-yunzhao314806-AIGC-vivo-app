...
- **Endpoint**：`POST https://app-bhs9a5otro5d-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-bhs9a5otro5d-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
