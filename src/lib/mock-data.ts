...
export const MOCK_JOBS: Job[] = [
  ...
  },
  {
    ...
    enterprise_id: 'mock-enterprise-1',
    title: '证券投资分析师',
    description: '负责A股市场及行业研究报告撰写，为基金经理提供投资建议。',
    requirements: '扎实的金融基础知识，CFA/CPA优先。',
    skills_required: ['金融分析', 'Excel', 'Wind', 'Python', '行业研究'],
    salary_min: 15000,
    salary_max: 30000,
    location: '上海·陆家嘴',
    industry: 'finance',
  ...
  },
  {
    ...
    enterprise_id: 'mock-enterprise-2',
    title: '风险控制专员',
    description: '建立并完善公司风控体系，监控贷款及投资风险。',
    requirements: '熟悉金融监管法规，具备风险建模能力。',
    skills_required: ['风险管理', 'SQL', '数据分析', '合规', '建模'],
    salary_min: 12000,
    salary_max: 22000,
    location: '北京·西城',
    industry: 'finance',
  ...
  },
  {
    ...
    enterprise_id: 'mock-enterprise-1',
    title: '精益生产工程师',
    description: '推行精益生产管理，优化生产流程，降低生产成本。',
    requirements: '熟悉精益/六西格玛方法论，有制造业实践经验。',
    skills_required: ['精益生产', '六西格玛', 'AutoCAD', 'ERP', '工业工程'],
    salary_min: 10000,
    salary_max: 18000,
    location: '苏州·工业园区',
  ...
  },
  {
    ...
    enterprise_id: 'mock-enterprise-2',
    title: '质量管理工程师',
    description: '制定并执行产品质量标准，负责来料/过程/出货检验。',
    requirements: 'ISO9001体系经验，熟悉FMEA/SPC等质量工具。',
    skills_required: ['质量管理', 'ISO9001', 'FMEA', 'SPC', '8D'],
    salary_min: 9000,
    salary_max: 16000,
    location: '深圳·龙华',
    industry: 'manufacturing',
  ...
  },
  {
    ...
    enterprise_id: 'mock-enterprise-1',
    title: '在线课程设计师',
    description: '负责K12/职业培训在线课程的策划、脚本编写及制作。',
    requirements: '有教育学或教学设计背景，熟悉主流在线教育平台。',
    skills_required: ['课程设计', 'PPT', '视频剪辑', 'Instructional Design', '学科知识'],
    salary_min: 8000,
    salary_max: 15000,
    location: '北京·朝阳',
    industry: 'education',
  ...
  },
  {
    ...
    enterprise_id: 'mock-enterprise-2',
    title: '少儿编程讲师',
    description: '为8-16岁学生讲授Scratch/Python/机器人编程课程。',
    requirements: '热爱教育，有青少年教育经验，编程基础扎实。',
    skills_required: ['Python', 'Scratch', '编程教育', '沟通', '课堂管理'],
    salary_min: 8000,
    salary_max: 14000,
    location: '成都·高新区',
    industry: 'education',
  ...
  },
  {
    ...
    enterprise_id: 'mock-enterprise-1',
    title: '医疗器械销售代表',
    description: '负责医疗器械产品的医院渠道开拓及维护。',
    requirements: '有医院资源或医疗器械销售经验，理工科背景优先。',
    skills_required: ['医疗器械', '销售', '客户开发', '行业知识', '谈判'],
    salary_min: 8000,
    salary_max: 20000,
    location: '北京·海淀',
    industry: 'medical',
  ...
  },
  {
    ...
    enterprise_id: 'mock-enterprise-2',
    title: '健康数据分析师',
    description: '分析临床及健康管理数据，支撑业务决策与产品优化。',
    requirements: '生物统计/流行病学背景，熟悉R/Python。',
    skills_required: ['R', 'Python', '统计分析', '医疗数据', 'SPSS'],
    salary_min: 15000,
    salary_max: 25000,
    location: '上海·徐汇',
    industry: 'medical',
